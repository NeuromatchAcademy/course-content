...
Goal is to decide what dataset/topic to work on and to form 2-3 separate groups (3-5 students/group). 
...
Brainstorm at the pod level (30 min): do you have an idea or a rough direction? Bring it out to the group. Start recruiting others to your group!
The TA will pay close attention to what you all are interested in, and will produce an initial set of three topics / datasets / ideas, outlined in a shared google doc. 
join one of these by writing your name down underneath the topic. 
once you “join”, feel free to propose modifications to the topic if that convinces others to join.    
Separate into groups. Now brainstorm within your group (30-90 min, breakout rooms). Definitely choose a dataset, and try to come up with one or a few topics of interest, either by yourself or directly from the booklet (i.e. project templates). 
...
No need to have something very concrete at this point. You will determine the feasibility of your questions in the next few days, and you will likely change your question completely. That’s how research works!  
...
You should now have a sense of the data, and you have probably refined your hypothesis a little. You might have a vague idea of what it would take for your project to work, what tools you might use, and what the answer could look like. Let’s make these things explicit, by continuing with steps 6-9 of the modelling practice in this new notebook. 
